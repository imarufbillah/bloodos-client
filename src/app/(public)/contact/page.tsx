...
import { Mail, Phone, MapPin, AlertCircle, Clock, ArrowRight, MessageSquare } from "lucide-react";
...
export default function ContactPage() {
  return (
    <div className="min-h-[calc(100dvh-4rem)] bg-background text-foreground flex flex-col justify-start py-10 sm:py-16 pb-24 sm:pb-16">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-destructive/30 bg-destructive/5 p-5 sm:p-6 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
          <div className="flex items-start gap-3.5 max-w-2xl">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-destructive text-destructive-foreground shadow-xs mt-0.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                Do not wait for a web inquiry response during acute hemorrhage. Use our live emergency dispatch network or call the emergency hotline directly.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-xs space-y-6">
          ...
          <div className="lg:col-span-5 space-y-6">
            {/* Direct Channel Items (Clean list, no nested cards) */}
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="tel:+8801700000000" className="font-mono text-xs font-semibold text-primary hover:underline block">
                      +880 1700-000000
                    </a>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="mailto:contact@bloodos.app" className="font-mono text-xs text-foreground/90 hover:text-teal transition-colors block">
                      contact@bloodos.app
                    </a>
            ...
            {/* SLA Commitments */}
            <div className="rounded-2xl border border-border bg-muted/20 p-5 space-y-3 text-xs text-muted-foreground">
