...
import { MapPin, ShieldCheck, Heart, Users, ArrowUpRight } from "lucide-react";
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3 rounded-xl border text-center transition-all ${
                    isSelected
                      ? "border-crimson bg-crimson/10 text-crimson font-bold shadow-sm"
            ...
            <div className="flex flex-wrap gap-2">
              {activeDistricts.map((district) => (
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg border border-border/80 bg-background px-3 py-1.5 text-xs font-medium text-foreground hover:border-crimson hover:text-crimson hover:bg-crimson/5 transition-all"
                >
