...
export default function GoogleAuth({ label = "Continue with Google" }: GoogleAuthProps) {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="lg"
      className="w-full h-11 min-h-[44px] gap-3 font-semibold text-sm border-border/80 bg-background hover:bg-muted/60 text-foreground transition-all duration-150 active:scale-[0.98] shadow-xs touch-manipulation"
      disabled={loading}
    >
